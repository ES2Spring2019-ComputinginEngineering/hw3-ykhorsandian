...
# YOUR COLLABORATION STATEMENT(s): I worked on this assignment with Allison Choi.
#
#*****************************************
...
while True:
    ...
    if ship_Y == asteroid_y and ship_X == asteroid_x :  #Test to see if the ship has hit an asteroid
        # STEP 1 ##########################################################
